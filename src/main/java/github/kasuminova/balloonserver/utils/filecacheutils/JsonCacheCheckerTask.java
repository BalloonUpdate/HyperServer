...
public record JsonCacheCheckerTask(
        ...
        String hashAlgorithm, NetworkLogger logger, AtomicInteger completedFiles, ExecutorService fileThreadPool)
     ...
     */
    public static void removeOldFiles(String path, Map<String, AbstractSimpleFileObject> fileObjMap, NetworkLogger logger) {
